...
Nesse dia, foi exercitado a pratica de utilizar as tags comumente usadas pelos desenvolvedores além das `divs` para manter a semântica durante a codagem, além de práticarmos a funcionalidade do `display` no CSS.
