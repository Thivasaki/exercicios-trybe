...
Esse é o primeiro dia onde o foco de aprendizagem é o comando `flexbox` e neste exercício foi nos dado um arquivo disponibilizado por um repositório no ‘Github’ onde precisávamos organizá-lo usando somente `flexbox`.
